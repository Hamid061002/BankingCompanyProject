      ...
      <div className="px-4">
         <div className="flex flex-col gap-10 lg:gap-[60px] w-full lg:w-[1064px] bgLoginSignUp bg-right-top p-[30px] lg:py-20 lg:px-[200px] mx-auto">
            ...
            <div className="flex flex-col items-center gap-[10px] lg:gap-4">
               <div className="LexendFontMedium text-[28px] lg:text-[38px] text-green-60 leading-normal">Login</div>
               <div className="LexendFontLight max-lg:text-sm text-grey-75 leading-normal">Welcome back! Please log in to access your account.</div>
            </div>
            {/* form */}
            <div>
