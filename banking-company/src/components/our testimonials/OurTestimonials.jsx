...
function OurTestimonials() {
   ...
   return (
      <section className="flex flex-col gap-[60px] lg:gap-20 px-4 lg:px-20">
         ...
         <div className="flex flex-col lg:flex-row gap-6 lg:gap-[150px] justify-center lg:justify-between items-center mt-[120px] lg:mt-10 rounded-[20px] border border-grey-15 p-[30px] lg:p-[60px] bgCTA bg-grey-11 bg-no-repeat">
